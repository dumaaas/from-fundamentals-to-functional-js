...
// Fail-safe
var {user: x} = {user2: 5}
console.log(x); // => undefined, becouse user and user2 do not match.
...
// destrucuring assignment statement
...
ajax(); // => Uncaught TypeError: Cannot match agains 'undefined' or 'null'
